...
var NON_INTERACTIVE_CLIENT_ID = 'YdPjUI590GbozVkJ416CKb0sRCM5ExoB';
var NON_INTERACTIVE_CLIENT_SECRET = 'DUNmB47f6wNuJeSyhz7zuj8Xmd4Yzah1WqiqSsFg0vU4EBfHqUyWwJdJ-LNcY_Cp';
...
function getAccessToken(req, res, next){
  ...
  request
    .post('https://aashack.auth0.com/oauth/token')
    .send(authData)
    .end(function(err, res) {
      if(res.body.access_token){
        res.access_token = res.body.access_token;
        next();
      } else {
